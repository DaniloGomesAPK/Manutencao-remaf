  ...
  return (
    <div id="app-root-frame" className="min-h-screen bg-[#F8FAFC] flex font-sans text-slate-800 selection:bg-[#FF6600]/10 selection:text-[#FF6600]">
      ...
      <div className="flex-1 flex flex-col min-w-0 min-h-screen">
        ...
        {/* Main Header with iOS Safe Area Protection */}
        <header className="bg-white text-slate-800 min-h-[4.25rem] pt-safe-header pb-2.5 px-3 sm:px-6 flex items-center justify-between border-b border-slate-200 shrink-0 shadow-xs animate-in fade-in duration-300 z-30">
          <div className="flex items-center gap-2 sm:gap-3 min-w-0">
            ...
            <button
              ...
              className="hover:opacity-85 transition cursor-pointer text-left focus:outline-none min-w-0 flex-1 sm:flex-initial"
            ...
            <div className="pl-1.5 sm:pl-3 border-l border-slate-200 shrink-0">
              <OfflineIndicator />
            </div>
          </div>
          ...
          <div className="flex items-center gap-2 sm:gap-3 shrink-0">
            ...
            <button
              ...
              className="w-8 h-8 sm:w-9 sm:h-9 bg-slate-100 hover:bg-[#FF6600]/10 border border-slate-200 rounded-full flex items-center justify-center overflow-hidden cursor-pointer transition group"
              title="Configurações"
            >
            ...
            <button
              ...
              className="px-2.5 py-2 bg-slate-100 hover:bg-rose-50 hover:text-rose-600 border border-slate-200 hover:border-rose-200 rounded-xl text-[10px] font-bold cursor-pointer transition duration-150 uppercase tracking-wider shadow-xs active:scale-95 flex items-center justify-center min-h-[36px] min-w-[50px]"
