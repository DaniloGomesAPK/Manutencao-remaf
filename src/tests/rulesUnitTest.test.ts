...
export async function runRulesUnitTests() {
  ...
  try {
    const licExpirada: LicencaAtual = {
      email: 'revogada_1@empresa.com',
      empresaId: 'emp_revogada_1',
      status: 'expired',
      plano: 'trial_7dias',
      validade: new Date(Date.now() - 2 * 24 * 60 * 60 * 1000).toISOString(),
      ativo: true,
      bloqueado: false,
      inicio: new Date(Date.now() - 9 * 24 * 60 * 60 * 1000).toISOString(),
      fim: new Date(Date.now() - 2 * 24 * 60 * 60 * 1000).toISOString(),
      trialInicio: new Date(Date.now() - 9 * 24 * 60 * 60 * 1000).toISOString(),
  ...
  try {
    const licOriginal: LicencaAtual = {
      ...
      fim: new Date(Date.now() + 7 * 24 * 60 * 60 * 1000).toISOString(),
